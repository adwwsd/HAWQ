  ...
  for (int ax0_inner_ax1_fused_inner = 0; ax0_inner_ax1_fused_inner < 4; ++ax0_inner_ax1_fused_inner) {
    ...
    for (int ic_outer = 0; ic_outer < 4; ++ic_outer) {
      ...
      for (int ax3 = 0; ax3 < 4; ++ax3) {
        ...
        for (int ax4_ax5_fused_inner_outer = 0; ax4_ax5_fused_inner_outer < 8; ++ax4_ax5_fused_inner_outer) {
          ((int*)compute_shared)[(((ax3 * 32) + ((int)threadIdx.x)))] = ((int*)placeholder)[((((((((((((int)blockIdx.z) * 4) + ax0_inner_ax1_fused_inner) / 14) * 28672) + ((((((int)blockIdx.z) * 4) + ax0_inner_ax1_fused_inner) % 14) * 1024)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) >> 5) * 64)) + (ic_outer * 16)) + (ax3 * 4)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) & 31) / 8)))];
        }
      }
      __syncthreads();
      #pragma unroll
    ...
    for (int ax3_outer_inner = 0; ax3_outer_inner < 8; ++ax3_outer_inner) {
      ...
      for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
        ((int*)T_cast)[((((((((((int)blockIdx.z) * 32768) + (ax0_inner_ax1_fused_inner * 8192)) + (ax2_inner_ax3_inner_fused_outer * 4096)) + ((((int)threadIdx.x) >> 3) * 1024)) + (((int)blockIdx.y) * 64)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))] = (((int*)placeholder_shared)[((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((int)threadIdx.x)))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 64) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))]);
      }
    }
  }
}
...
extern "C" __global__ void fused_nn_conv2d_add_cast_add_clip_cast_nn_relu_2_kernel0(void* __restrict__ placeholder, void* __restrict__ placeholder1, void* __restrict__ T_relu, void* __restrict__ placeholder2, void* __restrict__ placeholder3) {
  ...
  for (int ic_outer = 0; ic_outer < 2; ++ic_outer) {
    ...
    for (int ic_inner = 0; ic_inner < 2; ++ic_inner) {
      ...
      #pragma unroll
      for (int ax2 = 0; ax2 < 8; ++ax2) {
        ((int*)placeholder_shared)[(((ax2 * 32) + ((int)threadIdx.x)))] = ((int*)placeholder1)[((((((((int)blockIdx.y) * 1024) + (ax2 * 128)) + (ic_outer * 64)) + (ic_inner * 32)) + ((int)threadIdx.x)))];
      }
      __syncthreads();
      #pragma unroll
      for (int ax21 = 0; ax21 < 8; ++ax21) {
  ...
  for (int ax3_outer_inner = 0; ax3_outer_inner < 8; ++ax3_outer_inner) {
    #pragma unroll
    for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
      ((int*)T_relu)[(((((((((int)blockIdx.z) * 4096) + (ax2_inner_ax3_inner_fused_outer * 2048)) + ((((int)threadIdx.x) >> 3) * 512)) + (((int)blockIdx.y) * 64)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))] = max(min(((Conv[((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((int)threadIdx.x)))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 64) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))]) + ((int*)placeholder3)[(((((((((int)blockIdx.z) * 4096) + (ax2_inner_ax3_inner_fused_outer * 2048)) + ((((int)threadIdx.x) >> 3) * 512)) + (((int)blockIdx.y) * 64)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))]), 2147483647), 0);
    }
  }
}

extern "C" __global__ void fused_nn_pad_3_kernel0(void* __restrict__ T_pad, void* __restrict__ placeholder) {
  for (int ax0_ax1_fused_ax2_fused_ax3_fused_inner = 0; ax0_ax1_fused_ax2_fused_ax3_fused_inner < 8; ++ax0_ax1_fused_ax2_fused_ax3_fused_inner) {
...
extern "C" __global__ void fused_nn_conv2d_add_cast_3_kernel0(void* __restrict__ placeholder, void* __restrict__ placeholder1, void* __restrict__ T_cast, void* __restrict__ placeholder2) {
  ...
  for (int ic_outer = 0; ic_outer < 8; ++ic_outer) {
    ...
    for (int ax3 = 0; ax3 < 4; ++ax3) {
      #pragma unroll
      for (int ax4_ax5_fused_inner_outer = 0; ax4_ax5_fused_inner_outer < 8; ++ax4_ax5_fused_inner_outer) {
        ((int*)compute_shared)[(((ax3 * 32) + ((int)threadIdx.x)))] = ((int*)placeholder)[((((((((((int)blockIdx.z) / 7) * 28672) + ((((int)blockIdx.z) % 7) * 2048)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) >> 5) * 128)) + (ic_outer * 16)) + (ax3 * 4)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) & 31) / 8)))];
      }
    }
    __syncthreads();
    #pragma unroll
    ...
    for (int ax2 = 0; ax2 < 16; ++ax2) {
      #pragma unroll
      for (int ax3_inner_inner = 0; ax3_inner_inner < 4; ++ax3_inner_inner) {
        ((int*)placeholder_shared)[((((ax2 * 128) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder1)[((((((((int)blockIdx.y) * 16384) + (ax2 * 1024)) + (ic_outer * 128)) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))];
      }
    }
    __syncthreads();
    #pragma unroll
  ...
  for (int ax3_outer_inner = 0; ax3_outer_inner < 16; ++ax3_outer_inner) {
    #pragma unroll
    for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
      ((int*)T_cast)[(((((((((int)blockIdx.z) * 16384) + (ax2_inner_ax3_inner_fused_outer * 8192)) + ((((int)threadIdx.x) >> 3) * 2048)) + (((int)blockIdx.y) * 128)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))] = (((int*)placeholder_shared)[((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((int)threadIdx.x)))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 128) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))]);
    }
  }
}
...
extern "C" __global__ void fused_nn_conv2d_add_cast_cast_cast_multiply_add_right_shift_cast_add_clip_cast_n_16373524651668054328__2_kernel0(void* __restrict__ placeholder, void* __restrict__ placeholder1, void* __restrict__ T_relu, void* __restrict__ placeholder2, void* __restrict__ placeholder3) {
  ...
  for (int ax3_outer_inner = 0; ax3_outer_inner < 8; ++ax3_outer_inner) {
    #pragma unroll
    for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
      ((int*)T_relu)[(((((((((int)blockIdx.z) * 4096) + (ax2_inner_ax3_inner_fused_outer * 2048)) + ((((int)threadIdx.x) >> 3) * 512)) + (((int)blockIdx.y) * 64)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))] = max(min(((Conv[((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((int)threadIdx.x)))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 64) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))]) + ((int)(((((long)((int*)placeholder3)[(((((((((int)blockIdx.z) * 4096) + (ax2_inner_ax3_inner_fused_outer * 2048)) + ((((int)threadIdx.x) >> 3) * 512)) + (((int)blockIdx.y) * 64)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))]) * (long)1861152495) + (long)1073741824) >> (long)31))), 2147483647), 0);
    }
  }
}

extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__1_kernel0(unsigned int* __restrict__ compute, void* __restrict__ placeholder) {
  for (int h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner = 0; h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner < 8; ++h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) {
    ((int*)compute)[((((((((((int)blockIdx.x) * 8192) + (((int)threadIdx.x) * 8)) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) >> 14) * 2048) + ((((((int)blockIdx.x) * 32) + (((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) >> 8)) & 63) * 32)) + ((((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) & 255) / 8)))] = ((int*)placeholder)[(((((((((((int)blockIdx.x) * 8192) + (((int)threadIdx.x) * 8)) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) >> 14) * 2048) + (((((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) & 255) >> 5) * 256)) + ((((((int)blockIdx.x) * 32) + (((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) >> 8)) & 63) * 4)) + ((((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) & 31) / 8)))];
  }
}
  ...
  for (int ax0_ax1_fused_ax2_fused_ax3_fused_outer = 0; ax0_ax1_fused_ax2_fused_ax3_fused_outer < 25; ++ax0_ax1_fused_ax2_fused_ax3_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 4096) + (((int)blockIdx.x) * 16)) + (((int)threadIdx.x) >> 6)) < 100352) {
      if ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 262144) + (((int)blockIdx.x) * 1024)) + ((int)threadIdx.x)) < 6422528) {
        ((int*)T_relu)[((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 262144) + (((int)blockIdx.x) * 1024)) + ((int)threadIdx.x)))] = max(((int)(((((long)(gemm_C[((((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 262144) + (((int)blockIdx.x) * 1024)) + (((((int)threadIdx.x) & 63) >> 4) * 256)) + ((((int)threadIdx.x) >> 6) * 16)) + (((int)threadIdx.x) & 15)))] + ((int*)placeholder)[((((int)threadIdx.x) & 63))])) * (long)1832519380) + (long)1073741824) >> (long)31)), 0);
      }
    }
  }
}

extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__2_kernel0(unsigned int* __restrict__ compute, void* __restrict__ placeholder) {
  for (int h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner = 0; h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner < 8; ++h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) {
    ((int*)compute)[((((((((((int)blockIdx.x) * 8192) + (((int)threadIdx.x) * 8)) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) / 106496) * 13312) + ((((int)blockIdx.x) % 13) * 1024)) + ((int)threadIdx.x)))] = ((int*)placeholder)[((((((((((((int)blockIdx.x) * 8192) + (((int)threadIdx.x) * 8)) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) / 106496) * 14336) + ((((int)blockIdx.x) % 13) * 1024)) + (((((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) & 255) >> 5) * 128)) + ((((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) >> 8) * 4)) + ((((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) & 31) / 8)))];
  }
}
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__11_kernel0(void* __restrict__ placeholder, void* __restrict__ placeholder1, void* __restrict__ T_cast, void* __restrict__ placeholder2) {
  ...
  for (int ax3_outer_inner = 0; ax3_outer_inner < 2; ++ax3_outer_inner) {
    for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
      ((unsigned int*)T_cast)[((((((((int)blockIdx.z) * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + (((int)blockIdx.y) * 2)) + ax3_outer_inner))] = ((unsigned int)((((((((0 | ((max(min(((int)((((((long)max((Conv[((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)))] + ((int*)placeholder2)[(((((int)blockIdx.y) * 16) + (ax3_outer_inner * 8)))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 28)) | ((max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 1))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 16) + (ax3_outer_inner * 8)) + 1))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 24)) | ((max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 2))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 16) + (ax3_outer_inner * 8)) + 2))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 20)) | ((max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 3))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 16) + (ax3_outer_inner * 8)) + 3))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 16)) | ((max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 4))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 16) + (ax3_outer_inner * 8)) + 4))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 12)) | ((max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 5))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 16) + (ax3_outer_inner * 8)) + 5))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 8)) | ((max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 6))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 16) + (ax3_outer_inner * 8)) + 6))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 4)) | (max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 7))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 16) + (ax3_outer_inner * 8)) + 7))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15)));
    }
  }
}
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__8_kernel0(void* __restrict__ placeholder, void* __restrict__ placeholder1, void* __restrict__ T_cast, void* __restrict__ placeholder2) {
  ...
  __shared__ int placeholder_shared[4096];
  nvcuda::wmma::fragment<nvcuda::wmma::matrix_b, 8, 8, 32, nvcuda::wmma::experimental::precision::s4, nvcuda::wmma::col_major> placeholder_shared_wmma_matrix_b[64];
  #pragma unroll
  for (int ax0_inner_ax1_fused_inner = 0; ax0_inner_ax1_fused_inner < 4; ++ax0_inner_ax1_fused_inner) {
    #pragma unroll
    ...
    for (int ax3 = 0; ax3 < 8; ++ax3) {
      ...
      for (int ax4_ax5_fused_inner_outer = 0; ax4_ax5_fused_inner_outer < 8; ++ax4_ax5_fused_inner_outer) {
        if (((int)threadIdx.z) < 1) {
          ((int*)compute_shared)[((((((int)threadIdx.z) * 256) + (ax3 * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder)[((((((((((((int)blockIdx.z) * 4) + ax0_inner_ax1_fused_inner) / 28) * 28672) + ((((((int)blockIdx.z) * 4) + ax0_inner_ax1_fused_inner) % 28) * 512)) + (((int)threadIdx.z) * 256)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) >> 5) * 32)) + (ax3 * 4)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) & 31) / 8)))];
        }
      }
    }
    __syncthreads();
    ...
    for (int ax21 = 0; ax21 < 8; ++ax21) {
      ...
      for (int ax32 = 0; ax32 < 8; ++ax32) {
        (void)nvcuda::wmma::load_matrix_sync(placeholder_shared_wmma_matrix_b[((ax21 * 8) + ax32)], ((int *)placeholder_shared + (((((int)threadIdx.z) * 16384) + (ax21 * 2048)) + (ax32 * 256)) / 8), 32);
      }
    }
    #pragma unroll
    ...
    for (int ax3_outer_inner = 0; ax3_outer_inner < 8; ++ax3_outer_inner) {
      #pragma unroll
      for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
        ((unsigned int*)T_cast)[(((((((((int)blockIdx.z) * 512) + (ax0_inner_ax1_fused_inner * 128)) + (ax2_inner_ax3_inner_fused_outer * 64)) + ((((int)threadIdx.x) >> 3) * 16)) + (((int)threadIdx.z) * 8)) + ax3_outer_inner))] = ((unsigned int)((((((((0 | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)))] + ((int*)placeholder2)[(((((int)threadIdx.z) * 64) + (ax3_outer_inner * 8)))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 28)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 1))] + ((int*)placeholder2)[((((((int)threadIdx.z) * 64) + (ax3_outer_inner * 8)) + 1))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 24)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 2))] + ((int*)placeholder2)[((((((int)threadIdx.z) * 64) + (ax3_outer_inner * 8)) + 2))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 20)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 3))] + ((int*)placeholder2)[((((((int)threadIdx.z) * 64) + (ax3_outer_inner * 8)) + 3))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 16)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 4))] + ((int*)placeholder2)[((((((int)threadIdx.z) * 64) + (ax3_outer_inner * 8)) + 4))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 12)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 5))] + ((int*)placeholder2)[((((((int)threadIdx.z) * 64) + (ax3_outer_inner * 8)) + 5))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 8)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 6))] + ((int*)placeholder2)[((((((int)threadIdx.z) * 64) + (ax3_outer_inner * 8)) + 6))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 4)) | (max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 7))] + ((int*)placeholder2)[((((((int)threadIdx.z) * 64) + (ax3_outer_inner * 8)) + 7))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15)));
      }
    }
  }
}
  ...
  for (int ax0_inner_ax1_fused_inner = 0; ax0_inner_ax1_fused_inner < 4; ++ax0_inner_ax1_fused_inner) {
    ...
    for (int kh = 0; kh < 3; ++kh) {
      ...
      for (int kw = 0; kw < 3; ++kw) {
        ...
        #pragma unroll
        for (int ax2 = 0; ax2 < 16; ++ax2) {
          ((int*)placeholder_shared)[((((ax2 * 128) + (((int)threadIdx.z) * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder)[((((((kh * 6144) + (kw * 2048)) + (ax2 * 128)) + (((int)threadIdx.z) * 32)) + ((int)threadIdx.x)))];
        }
        __syncthreads();
        #pragma unroll
    ...
    for (int ax3_outer_inner = 0; ax3_outer_inner < 4; ++ax3_outer_inner) {
      #pragma unroll
      for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
        ((unsigned int*)T_cast)[(((((((((int)blockIdx.z) * 512) + (ax0_inner_ax1_fused_inner * 128)) + (ax2_inner_ax3_inner_fused_outer * 64)) + ((((int)threadIdx.x) >> 3) * 16)) + (((int)threadIdx.z) * 4)) + ax3_outer_inner))] = ((unsigned int)((((((((0 | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((((int)threadIdx.z) * 256) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)))] + ((int*)placeholder1)[(((((int)threadIdx.z) * 32) + (ax3_outer_inner * 8)))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 28)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 256) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 1))] + ((int*)placeholder1)[((((((int)threadIdx.z) * 32) + (ax3_outer_inner * 8)) + 1))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 24)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 256) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 2))] + ((int*)placeholder1)[((((((int)threadIdx.z) * 32) + (ax3_outer_inner * 8)) + 2))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 20)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 256) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 3))] + ((int*)placeholder1)[((((((int)threadIdx.z) * 32) + (ax3_outer_inner * 8)) + 3))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 16)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 256) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 4))] + ((int*)placeholder1)[((((((int)threadIdx.z) * 32) + (ax3_outer_inner * 8)) + 4))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 12)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 256) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 5))] + ((int*)placeholder1)[((((((int)threadIdx.z) * 32) + (ax3_outer_inner * 8)) + 5))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 8)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 256) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 6))] + ((int*)placeholder1)[((((((int)threadIdx.z) * 32) + (ax3_outer_inner * 8)) + 6))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 4)) | (max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 256) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 7))] + ((int*)placeholder1)[((((((int)threadIdx.z) * 32) + (ax3_outer_inner * 8)) + 7))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15)));
      }
    }
  }
}
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__4_kernel0(void* __restrict__ placeholder, void* __restrict__ placeholder1, void* __restrict__ T_cast, void* __restrict__ placeholder2) {
  ...
  for (int ic_outer = 0; ic_outer < 16; ++ic_outer) {
    ...
    for (int ax3 = 0; ax3 < 2; ++ax3) {
      #pragma unroll
      for (int ax4_ax5_fused_inner_outer = 0; ax4_ax5_fused_inner_outer < 8; ++ax4_ax5_fused_inner_outer) {
        ((int*)compute_shared)[(((ax3 * 32) + ((int)threadIdx.x)))] = ((int*)placeholder)[((((((((int)blockIdx.z) * 1024) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) >> 5) * 128)) + (ic_outer * 8)) + (ax3 * 4)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) & 31) / 8)))];
      }
    }
    __syncthreads();
    #pragma unroll
    ...
    for (int ax2 = 0; ax2 < 16; ++ax2) {
      ...
      for (int ax3_inner_inner = 0; ax3_inner_inner < 2; ++ax3_inner_inner) {
        #pragma unroll
        for (int ax4_ax5_fused_inner_inner = 0; ax4_ax5_fused_inner_inner < 8; ++ax4_ax5_fused_inner_inner) {
          ((int*)placeholder_shared)[((((ax2 * 64) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder1)[((((((((int)blockIdx.y) * 16384) + (ax2 * 1024)) + (ic_outer * 64)) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))];
        }
      }
    }
    __syncthreads();
  ...
  for (int ax3_outer_inner = 0; ax3_outer_inner < 16; ++ax3_outer_inner) {
    #pragma unroll
    for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
      ((unsigned int*)T_cast)[((((((((int)blockIdx.z) * 256) + (ax2_inner_ax3_inner_fused_outer * 128)) + ((((int)threadIdx.x) >> 3) * 32)) + (((int)blockIdx.y) * 16)) + ax3_outer_inner))] = ((unsigned int)((((((((0 | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)))] + ((int*)placeholder2)[(((((int)blockIdx.y) * 128) + (ax3_outer_inner * 8)))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 28)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 1))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 128) + (ax3_outer_inner * 8)) + 1))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 24)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 2))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 128) + (ax3_outer_inner * 8)) + 2))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 20)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 3))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 128) + (ax3_outer_inner * 8)) + 3))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 16)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 4))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 128) + (ax3_outer_inner * 8)) + 4))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 12)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 5))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 128) + (ax3_outer_inner * 8)) + 5))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 8)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 6))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 128) + (ax3_outer_inner * 8)) + 6))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 4)) | (max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 7))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 128) + (ax3_outer_inner * 8)) + 7))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15)));
    }
  }
}
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__kernel1(unsigned int* __restrict__ compute, void* __restrict__ placeholder, void* __restrict__ T_cast, void* __restrict__ placeholder1) {
    ...
    for (int ic_outer = 0; ic_outer < 4; ++ic_outer) {
      ...
      for (int ax1 = 0; ax1 < 3; ++ax1) {
        ...
        for (int ax3 = 0; ax3 < 4; ++ax3) {
          #pragma unroll
          for (int ax4_ax5_fused_inner_outer = 0; ax4_ax5_fused_inner_outer < 8; ++ax4_ax5_fused_inner_outer) {
            ((int*)compute_shared)[((((ax1 * 128) + (ax3 * 32)) + ((int)threadIdx.x)))] = ((int*)compute)[(((((((((((int)blockIdx.z) / 7) * 4608) + (kh * 4608)) + (ax1 * 512)) + ((((int)blockIdx.z) % 7) * 512)) + (ic_outer * 128)) + (ax3 * 32)) + ((int)threadIdx.x)))];
          }
        }
      }
      __syncthreads();
      ...
      for (int kw = 0; kw < 3; ++kw) {
        ...
        for (int ax2 = 0; ax2 < 8; ++ax2) {
          #pragma unroll
          for (int ax3_inner_inner = 0; ax3_inner_inner < 4; ++ax3_inner_inner) {
            ((int*)placeholder_shared)[((((ax2 * 128) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder)[((((((((kh * 98304) + (kw * 32768)) + (((int)blockIdx.y) * 4096)) + (ax2 * 512)) + (ic_outer * 128)) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))];
          }
        }
        __syncthreads();
        #pragma unroll
  ...
  for (int ax3_outer_inner = 0; ax3_outer_inner < 8; ++ax3_outer_inner) {
    #pragma unroll
    for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
      ((unsigned int*)T_cast)[((((((((int)blockIdx.z) * 512) + (ax2_inner_ax3_inner_fused_outer * 256)) + ((((int)threadIdx.x) >> 3) * 64)) + (((int)blockIdx.y) * 8)) + ax3_outer_inner))] = ((unsigned int)((((((((0 | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)))] + ((int*)placeholder1)[(((((int)blockIdx.y) * 64) + (ax3_outer_inner * 8)))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 28)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 1))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 64) + (ax3_outer_inner * 8)) + 1))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 24)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 2))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 64) + (ax3_outer_inner * 8)) + 2))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 20)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 3))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 64) + (ax3_outer_inner * 8)) + 3))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 16)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 4))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 64) + (ax3_outer_inner * 8)) + 4))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 12)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 5))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 64) + (ax3_outer_inner * 8)) + 5))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 8)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 6))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 64) + (ax3_outer_inner * 8)) + 6))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 4)) | (max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 7))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 64) + (ax3_outer_inner * 8)) + 7))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15)));
    }
  }
}
...
extern "C" __global__ void fused_nn_conv2d_add_cast_cast_multiply_add_right_shift_cast_nn_relu_kernel1(void* __restrict__ placeholder, signed char* __restrict__ kernel_im2col_pack, int* __restrict__ gemm_C) {
  nvcuda::wmma::fragment<nvcuda::wmma::accumulator, 16, 16, 16, int> gemm_C_wmma_accumulator[4];
  __shared__ signed char data_im2col_pack_shared[20480];
  __shared__ signed char kernel_im2col_pack_shared[10240];
  nvcuda::wmma::fragment<nvcuda::wmma::matrix_a, 16, 16, 16, signed char, nvcuda::wmma::row_major> data_im2col_pack_shared_wmma_matrix_a[2];
  ...
  for (int i_c_init = 0; i_c_init < 2; ++i_c_init) {
    for (int j_c_init = 0; j_c_init < 2; ++j_c_init) {
      (void)nvcuda::wmma::fill_fragment(gemm_C_wmma_accumulator[((i_c_init * 2) + j_c_init)], 0.000000e+00f);
    }
  }
  for (int ax0_inner = 0; ax0_inner < 2; ++ax0_inner) {
    for (int ax1_inner = 0; ax1_inner < 5; ++ax1_inner) {
      for (int ax2_ax3_fused_inner_inner_s = 0; ax2_ax3_fused_inner_inner_s < 8; ++ax2_ax3_fused_inner_inner_s) {
        data_im2col_pack_shared[(((((((((int)threadIdx.y) * 5120) + (ax0_inner * 2560)) + (((int)threadIdx.z) * 1280)) + (ax1_inner * 256)) + (((int)threadIdx.x) * 8)) + ax2_ax3_fused_inner_inner_s))] = (((((((int)threadIdx.z) * 80) + (ax1_inner * 16)) + (((((int)threadIdx.x) * 8) + ax2_ax3_fused_inner_inner_s) & 15)) < 147) ? ((signed char*)placeholder)[(((((((((((((int)blockIdx.x) * 128) + (((int)threadIdx.y) * 32)) + (ax0_inner * 16)) + (((((int)threadIdx.x) * 8) + ax2_ax3_fused_inner_inner_s) >> 4)) / 12544) * 158700) + (((((((((int)blockIdx.x) * 128) + (((int)threadIdx.y) * 32)) + (ax0_inner * 16)) + (((((int)threadIdx.x) * 8) + ax2_ax3_fused_inner_inner_s) >> 4)) % 12544) / 112) * 1380)) + (((((((int)threadIdx.z) * 80) + (ax1_inner * 16)) + (((((int)threadIdx.x) * 8) + ax2_ax3_fused_inner_inner_s) & 15)) / 21) * 690)) + ((((((((int)blockIdx.x) * 128) + (((int)threadIdx.y) * 32)) + (ax0_inner * 16)) + (((((int)threadIdx.x) * 8) + ax2_ax3_fused_inner_inner_s) >> 4)) % 112) * 6)) + ((((((int)threadIdx.z) * 80) + (ax1_inner * 16)) + (((((int)threadIdx.x) * 8) + ax2_ax3_fused_inner_inner_s) & 15)) % 21)))] : (signed char)0);
      }
    }
  }
  ...
  for (int k1_inner = 0; k1_inner < 10; ++k1_inner) {
    for (int ax0 = 0; ax0 < 2; ++ax0) {
      (void)nvcuda::wmma::load_matrix_sync(data_im2col_pack_shared_wmma_matrix_a[ax0], ((signed char *)data_im2col_pack_shared + (((((int)threadIdx.y) * 5120) + (ax0 * 2560)) + (k1_inner * 256))), 16);
    }
    for (int ax01 = 0; ax01 < 2; ++ax01) {
      (void)nvcuda::wmma::load_matrix_sync(kernel_im2col_pack_shared_wmma_matrix_b[ax01], ((signed char *)kernel_im2col_pack_shared + (((((int)threadIdx.z) * 5120) + (ax01 * 2560)) + (k1_inner * 256))), 16);
    }
    for (int i_c = 0; i_c < 2; ++i_c) {
      for (int j_c = 0; j_c < 2; ++j_c) {
        (void)nvcuda::wmma::mma_sync(gemm_C_wmma_accumulator[((i_c * 2) + j_c)], data_im2col_pack_shared_wmma_matrix_a[i_c], kernel_im2col_pack_shared_wmma_matrix_b[j_c], gemm_C_wmma_accumulator[((i_c * 2) + j_c)]);
      }
    }
  }
  for (int i_inner = 0; i_inner < 2; ++i_inner) {
    for (int j_inner = 0; j_inner < 2; ++j_inner) {
      (void)nvcuda::wmma::store_matrix_sync(((int *)gemm_C + (((((((int)blockIdx.x) * 8192) + (((int)threadIdx.y) * 2048)) + (i_inner * 1024)) + (((int)threadIdx.z) * 512)) + (j_inner * 256))), gemm_C_wmma_accumulator[((i_inner * 2) + j_inner)], 16, nvcuda::wmma::mem_row_major);
    }
  }
}
...
extern "C" __global__ void fused_nn_conv2d_add_cast_add_clip_cast_nn_relu_kernel1(unsigned int* __restrict__ compute, void* __restrict__ placeholder, void* __restrict__ T_relu, void* __restrict__ placeholder1, void* __restrict__ placeholder2) {
  ...
  for (int ax0_inner_ax1_fused_inner = 0; ax0_inner_ax1_fused_inner < 2; ++ax0_inner_ax1_fused_inner) {
    ...
    for (int ax3 = 0; ax3 < 16; ++ax3) {
      if (((int)threadIdx.z) < 1) {
        if (((((int)blockIdx.z) * 2) + ax0_inner_ax1_fused_inner) < 49) {
          ((int*)compute_shared)[((((((int)threadIdx.z) * 512) + (ax3 * 32)) + ((int)threadIdx.x)))] = ((int*)compute)[((((((((int)blockIdx.z) * 1024) + (((int)threadIdx.z) * 512)) + (ax0_inner_ax1_fused_inner * 512)) + (ax3 * 32)) + ((int)threadIdx.x)))];
        }
      }
    }
    __syncthreads();
    ...
    for (int ic_outer = 0; ic_outer < 8; ++ic_outer) {
      ...
      #pragma unroll
      for (int ax2 = 0; ax2 < 16; ++ax2) {
        ((int*)placeholder_shared)[((((ax2 * 64) + (((int)threadIdx.z) * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder)[((((((((int)blockIdx.y) * 8192) + (ax2 * 512)) + (ic_outer * 64)) + (((int)threadIdx.z) * 32)) + ((int)threadIdx.x)))];
      }
      __syncthreads();
      #pragma unroll
      for (int ax21 = 0; ax21 < 8; ++ax21) {
        #pragma unroll
        for (int ax32 = 0; ax32 < 2; ++ax32) {
          (void)nvcuda::wmma::load_matrix_sync(placeholder_shared_wmma_matrix_b[((ax21 * 2) + ax32)], ((int *)placeholder_shared + (((((int)threadIdx.z) * 4096) + (ax21 * 512)) + (ax32 * 256)) / 8), 32);
        }
      }
      #pragma unroll
      for (int ic_inner = 0; ic_inner < 2; ++ic_inner) {
    ...
    for (int ax3_outer_inner = 0; ax3_outer_inner < 8; ++ax3_outer_inner) {
      ...
      for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
        if (((((int)blockIdx.z) * 2) + ax0_inner_ax1_fused_inner) < 49) {
          ((int*)T_relu)[(((((((((((int)blockIdx.z) * 32768) + (ax0_inner_ax1_fused_inner * 16384)) + (ax2_inner_ax3_inner_fused_outer * 8192)) + ((((int)threadIdx.x) >> 3) * 2048)) + (((int)blockIdx.y) * 128)) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))] = max(min(((((int*)placeholder_shared)[(((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((int)threadIdx.x)))] + ((int*)placeholder1)[(((((((int)blockIdx.y) * 128) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))]) + ((int*)placeholder2)[(((((((((((int)blockIdx.z) * 32768) + (ax0_inner_ax1_fused_inner * 16384)) + (ax2_inner_ax3_inner_fused_outer * 8192)) + ((((int)threadIdx.x) >> 3) * 2048)) + (((int)blockIdx.y) * 128)) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))]), 2147483647), 0);
        }
      }
    }
  }
...
extern "C" __global__ void fused_nn_conv2d_add_cast_cast_cast_multiply_add_right_shift_cast_add_clip_cast_n_16373524651668054328__kernel1(unsigned int* __restrict__ compute, void* __restrict__ placeholder, void* __restrict__ T_relu, void* __restrict__ placeholder1, void* __restrict__ placeholder2) {
  ...
  for (int ax0_inner_ax1_fused_inner = 0; ax0_inner_ax1_fused_inner < 2; ++ax0_inner_ax1_fused_inner) {
    ...
    for (int ax3_outer_inner = 0; ax3_outer_inner < 8; ++ax3_outer_inner) {
      ...
      for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
        if (((((int)blockIdx.z) * 2) + ax0_inner_ax1_fused_inner) < 49) {
          ((int*)T_relu)[(((((((((((int)blockIdx.z) * 32768) + (ax0_inner_ax1_fused_inner * 16384)) + (ax2_inner_ax3_inner_fused_outer * 8192)) + ((((int)threadIdx.x) >> 3) * 2048)) + (((int)blockIdx.y) * 128)) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))] = max(min(((((int*)placeholder_shared)[(((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((int)threadIdx.x)))] + ((int*)placeholder1)[(((((((int)blockIdx.y) * 128) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))]) + ((int)(((((long)((int*)placeholder2)[(((((((((((int)blockIdx.z) * 32768) + (ax0_inner_ax1_fused_inner * 16384)) + (ax2_inner_ax3_inner_fused_outer * 8192)) + ((((int)threadIdx.x) >> 3) * 2048)) + (((int)blockIdx.y) * 128)) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))]) * (long)1861152495) + (long)1073741824) >> (long)31))), 2147483647), 0);
        }
      }
    }
  }
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__7_kernel0(void* __restrict__ placeholder, void* __restrict__ placeholder1, void* __restrict__ T_cast, void* __restrict__ placeholder2) {
  ...
  for (int ax0_inner_ax1_fused_inner = 0; ax0_inner_ax1_fused_inner < 2; ++ax0_inner_ax1_fused_inner) {
    ...
    for (int ax3 = 0; ax3 < 16; ++ax3) {
      ...
      for (int ax4_ax5_fused_inner_outer = 0; ax4_ax5_fused_inner_outer < 8; ++ax4_ax5_fused_inner_outer) {
        if (((int)threadIdx.z) < 1) {
          ((int*)compute_shared)[((((((int)threadIdx.z) * 512) + (ax3 * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder)[(((((((((int)blockIdx.z) * 1024) + (ax0_inner_ax1_fused_inner * 512)) + (((int)threadIdx.z) * 512)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) >> 5) * 64)) + (ax3 * 4)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) & 31) / 8)))];
        }
      }
    }
    __syncthreads();
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__2_kernel1(unsigned int* __restrict__ compute, void* __restrict__ placeholder, void* __restrict__ T_cast, void* __restrict__ placeholder1) {
  nvcuda::wmma::fragment<nvcuda::wmma::accumulator, 8, 8, 32, int> Conv_wmma_accumulator[4];
  __shared__ unsigned int compute_shared[256];
  nvcuda::wmma::fragment<nvcuda::wmma::matrix_a, 8, 8, 32, nvcuda::wmma::experimental::precision::u4, nvcuda::wmma::row_major> compute_shared_wmma_matrix_a[8];
  __shared__ int placeholder_shared[1024];
  ...
  for (int ic_outer = 0; ic_outer < 4; ++ic_outer) {
    #pragma unroll
    for (int ax3 = 0; ax3 < 8; ++ax3) {
      ((int*)compute_shared)[(((ax3 * 32) + ((int)threadIdx.x)))] = ((int*)compute)[(((((((((int)blockIdx.z) / 7) * 26624) + ((((int)blockIdx.z) % 7) * 2048)) + (ic_outer * 256)) + (ax3 * 32)) + ((int)threadIdx.x)))];
    }
    __syncthreads();
    #pragma unroll
    for (int ax31 = 0; ax31 < 8; ++ax31) {
    ...
    for (int ax2 = 0; ax2 < 4; ++ax2) {
      ...
      for (int ax3_inner_inner = 0; ax3_inner_inner < 8; ++ax3_inner_inner) {
        ((int*)placeholder_shared)[((((ax2 * 256) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder)[((((((((int)blockIdx.y) * 4096) + (ax2 * 1024)) + (ic_outer * 256)) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))];
      }
    }
    __syncthreads();
    #pragma unroll
  ...
  for (int ax3_outer_inner = 0; ax3_outer_inner < 4; ++ax3_outer_inner) {
    #pragma unroll
    for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
      ((unsigned int*)T_cast)[((((((((int)blockIdx.z) * 512) + (ax2_inner_ax3_inner_fused_outer * 256)) + ((((int)threadIdx.x) >> 3) * 64)) + (((int)blockIdx.y) * 4)) + ax3_outer_inner))] = ((unsigned int)((((((((0 | ((max(min(((int)((((((long)max((((int*)compute_shared)[((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)))] + ((int*)placeholder1)[(((((int)blockIdx.y) * 32) + (ax3_outer_inner * 8)))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 28)) | ((max(min(((int)((((((long)max((((int*)compute_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 1))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 32) + (ax3_outer_inner * 8)) + 1))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 24)) | ((max(min(((int)((((((long)max((((int*)compute_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 2))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 32) + (ax3_outer_inner * 8)) + 2))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 20)) | ((max(min(((int)((((((long)max((((int*)compute_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 3))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 32) + (ax3_outer_inner * 8)) + 3))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 16)) | ((max(min(((int)((((((long)max((((int*)compute_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 4))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 32) + (ax3_outer_inner * 8)) + 4))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 12)) | ((max(min(((int)((((((long)max((((int*)compute_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 5))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 32) + (ax3_outer_inner * 8)) + 5))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 8)) | ((max(min(((int)((((((long)max((((int*)compute_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 6))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 32) + (ax3_outer_inner * 8)) + 6))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 4)) | (max(min(((int)((((((long)max((((int*)compute_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 7))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 32) + (ax3_outer_inner * 8)) + 7))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15)));
    }
  }
}
  ...
  for (int ax0_inner_ax1_fused_inner = 0; ax0_inner_ax1_fused_inner < 8; ++ax0_inner_ax1_fused_inner) {
    ...
    for (int ic_outer = 0; ic_outer < 2; ++ic_outer) {
      ...
      for (int ax3 = 0; ax3 < 4; ++ax3) {
        ...
        for (int ax4_ax5_fused_inner_outer = 0; ax4_ax5_fused_inner_outer < 8; ++ax4_ax5_fused_inner_outer) {
          if (((int)threadIdx.z) < 1) {
            ((int*)compute_shared)[((((((int)threadIdx.z) * 128) + (ax3 * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder)[(((((((((((((int)blockIdx.z) * 8) + ax0_inner_ax1_fused_inner) / 28) * 28672) + ((((((int)blockIdx.z) * 8) + ax0_inner_ax1_fused_inner) % 28) * 512)) + (((int)threadIdx.z) * 256)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) >> 5) * 32)) + (ic_outer * 16)) + (ax3 * 4)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) & 31) / 8)))];
          }
        }
      }
      __syncthreads();
      ...
      for (int ax2 = 0; ax2 < 32; ++ax2) {
        ((int*)placeholder_shared)[((((ax2 * 128) + (((int)threadIdx.z) * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder1)[((((((((int)blockIdx.y) * 8192) + (ax2 * 256)) + (ic_outer * 128)) + (((int)threadIdx.z) * 32)) + ((int)threadIdx.x)))];
      }
      __syncthreads();
      #pragma unroll
      for (int ax21 = 0; ax21 < 8; ++ax21) {
    ...
    for (int ax3_outer_inner = 0; ax3_outer_inner < 8; ++ax3_outer_inner) {
      #pragma unroll
      for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
        ((int*)T_cast)[(((((((((((int)blockIdx.z) * 32768) + (ax0_inner_ax1_fused_inner * 4096)) + (ax2_inner_ax3_inner_fused_outer * 2048)) + ((((int)threadIdx.x) >> 3) * 512)) + (((int)blockIdx.y) * 256)) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))] = (((int*)placeholder_shared)[(((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((int)threadIdx.x)))] + ((int*)placeholder2)[(((((((int)blockIdx.y) * 256) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + (((int)threadIdx.x) & 7)))]);
      }
    }
  }
}
...
extern "C" __global__ void fused_nn_conv2d_add_cast_add_clip_cast_nn_relu_3_kernel0(void* __restrict__ placeholder, void* __restrict__ placeholder1, void* __restrict__ T_relu, void* __restrict__ placeholder2, void* __restrict__ placeholder3) {
  ...
  for (int ic_outer = 0; ic_outer < 2; ++ic_outer) {
    #pragma unroll
    for (int ax4_ax5_fused_inner_outer = 0; ax4_ax5_fused_inner_outer < 8; ++ax4_ax5_fused_inner_outer) {
      ((int*)compute_shared)[(((int)threadIdx.x))] = ((int*)placeholder)[(((((((int)blockIdx.z) * 64) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) >> 5) * 8)) + (ic_outer * 4)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) & 31) / 8)))];
    }
    __syncthreads();
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__1_kernel1(unsigned int* __restrict__ compute, void* __restrict__ placeholder, void* __restrict__ T_cast, void* __restrict__ placeholder1) {
  nvcuda::wmma::fragment<nvcuda::wmma::accumulator, 8, 8, 32, int> Conv_wmma_accumulator[8];
  __shared__ unsigned int compute_shared[128];
  nvcuda::wmma::fragment<nvcuda::wmma::matrix_a, 8, 8, 32, nvcuda::wmma::experimental::precision::u4, nvcuda::wmma::row_major> compute_shared_wmma_matrix_a[4];
  __shared__ int placeholder_shared[1024];
  ...
  for (int ic_outer = 0; ic_outer < 16; ++ic_outer) {
    for (int ax3 = 0; ax3 < 4; ++ax3) {
      ((int*)compute_shared)[(((ax3 * 32) + ((int)threadIdx.x)))] = ((int*)compute)[(((((((int)blockIdx.z) * 2048) + (ic_outer * 128)) + (ax3 * 32)) + ((int)threadIdx.x)))];
    }
    __syncthreads();
    for (int ax31 = 0; ax31 < 4; ++ax31) {
      (void)nvcuda::wmma::load_matrix_sync(compute_shared_wmma_matrix_a[ax31], ((unsigned int *)compute_shared + (ax31 * 256) / 8), 32);
    ...
    for (int ax2 = 0; ax2 < 8; ++ax2) {
      for (int ax3_inner_inner = 0; ax3_inner_inner < 4; ++ax3_inner_inner) {
        for (int ax4_ax5_fused_inner_inner = 0; ax4_ax5_fused_inner_inner < 8; ++ax4_ax5_fused_inner_inner) {
          ((int*)placeholder_shared)[((((ax2 * 128) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder)[((((((((int)blockIdx.y) * 16384) + (ax2 * 2048)) + (ic_outer * 128)) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))];
        }
      }
    }
    __syncthreads();
...
extern "C" __global__ void fused_nn_dense_add_cast_subtract_cast_multiply_kernel0(void* __restrict__ placeholder, void* __restrict__ placeholder1, void* __restrict__ T_multiply, void* __restrict__ placeholder2) {
  ...
  for (int j_c_init = 0; j_c_init < 5; ++j_c_init) {
  ...
  for (int k_outer_outer = 0; k_outer_outer < 8; ++k_outer_outer) {
    ...
    for (int k_outer_inner = 0; k_outer_inner < 64; ++k_outer_inner) {
      for (int j_c = 0; j_c < 5; ++j_c) {
        compute_local[(j_c)] = __dp4a(((int*)(placeholder_shared + (((((int)threadIdx.y) * 256) + (k_outer_inner * 4)))))[0], ((int*)(placeholder_shared1 + ((((((int)threadIdx.x) * 1280) + (j_c * 256)) + (k_outer_inner * 4)))))[0], compute_local[(j_c)]);
      }
    }
  }
  for (int ax1_inner_inner_inner = 0; ax1_inner_inner_inner < 5; ++ax1_inner_inner_inner) {
    ((float*)T_multiply)[(((((((int)threadIdx.y) * 1000) + (((int)blockIdx.x) * 10)) + (((int)threadIdx.x) * 5)) + ax1_inner_inner_inner))] = (((float)(compute_local[(ax1_inner_inner_inner)] + ((int*)placeholder2)[((((((int)blockIdx.x) * 10) + (((int)threadIdx.x) * 5)) + ax1_inner_inner_inner))])) * 7.500000e+01f);
  }
}
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__3_kernel0(unsigned int* __restrict__ compute, void* __restrict__ placeholder) {
  for (int h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner = 0; h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner < 8; ++h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) {
    ((int*)compute)[((((((((((int)blockIdx.x) * 8192) + (((int)threadIdx.x) * 8)) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) >> 15) * 4096) + ((((((int)blockIdx.x) * 4) + (((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) >> 11)) & 15) * 256)) + ((((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) & 2047) / 8)))] = ((int*)placeholder)[((((((((((((int)blockIdx.x) * 8192) + (((int)threadIdx.x) * 8)) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) >> 15) * 4096) + ((((((int)blockIdx.x) * 4) + (((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) >> 11)) & 15) * 256)) + (((((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) & 255) >> 5) * 32)) + (((((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) & 2047) >> 8) * 4)) + ((((((int)threadIdx.x) * 8) + h_w_fused_n_fused_i_fused_nn_fused_ii_fused_inner) & 31) / 8)))];
  }
}
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__10_kernel0(void* __restrict__ placeholder, void* __restrict__ placeholder1, void* __restrict__ T_cast, void* __restrict__ placeholder2) {
  ...
  for (int ax0_inner_ax1_fused_inner = 0; ax0_inner_ax1_fused_inner < 2; ++ax0_inner_ax1_fused_inner) {
    ...
    for (int ax3 = 0; ax3 < 8; ++ax3) {
      #pragma unroll
      for (int ax4_ax5_fused_inner_outer = 0; ax4_ax5_fused_inner_outer < 8; ++ax4_ax5_fused_inner_outer) {
        ((int*)compute_shared)[(((ax3 * 32) + ((int)threadIdx.x)))] = ((int*)placeholder)[((((((((int)blockIdx.z) * 512) + (ax0_inner_ax1_fused_inner * 256)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) >> 5) * 32)) + (ax3 * 4)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) & 31) / 8)))];
      }
    }
    __syncthreads();
    #pragma unroll
    ...
    for (int ax2 = 0; ax2 < 8; ++ax2) {
      #pragma unroll
      for (int ax3_inner_inner = 0; ax3_inner_inner < 8; ++ax3_inner_inner) {
        ((int*)placeholder_shared)[((((ax2 * 256) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder1)[((((ax2 * 256) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))];
      }
    }
    __syncthreads();
    #pragma unroll
    ...
    for (int ax3_outer_inner = 0; ax3_outer_inner < 8; ++ax3_outer_inner) {
      #pragma unroll
      for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
        ((unsigned int*)T_cast)[((((((((int)blockIdx.z) * 128) + (ax0_inner_ax1_fused_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + ax3_outer_inner))] = ((unsigned int)((((((((0 | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)))] + ((int*)placeholder2)[((ax3_outer_inner * 8))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 28)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 1))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 1))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 24)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 2))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 2))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 20)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 3))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 3))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 16)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 4))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 4))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 12)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 5))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 5))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 8)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 6))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 6))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 4)) | (max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 7))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 7))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15)));
      }
    }
  }
}

extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__3_kernel1(unsigned int* __restrict__ compute, void* __restrict__ placeholder, void* __restrict__ T_cast, void* __restrict__ placeholder1) {
  nvcuda::wmma::fragment<nvcuda::wmma::accumulator, 8, 8, 32, int> Conv_wmma_accumulator[2];
  __shared__ unsigned int compute_shared[256];
  nvcuda::wmma::fragment<nvcuda::wmma::matrix_a, 8, 8, 32, nvcuda::wmma::experimental::precision::u4, nvcuda::wmma::row_major> compute_shared_wmma_matrix_a[8];
  __shared__ int placeholder_shared[2048];
  ...
  for (int ax0_inner_ax1_fused_inner = 0; ax0_inner_ax1_fused_inner < 4; ++ax0_inner_ax1_fused_inner) {
    ...
    for (int kh = 0; kh < 3; ++kh) {
      ...
      for (int kw = 0; kw < 3; ++kw) {
        ...
        for (int ax3 = 0; ax3 < 8; ++ax3) {
          if (((int)threadIdx.z) < 1) {
            ((int*)compute_shared)[((((((int)threadIdx.z) * 256) + (ax3 * 32)) + ((int)threadIdx.x)))] = ((int*)compute)[(((((((((((((int)blockIdx.z) * 4) + ax0_inner_ax1_fused_inner) / 14) * 4096) + (kh * 4096)) + (kw * 256)) + (((int)threadIdx.z) * 256)) + ((((((int)blockIdx.z) * 4) + ax0_inner_ax1_fused_inner) % 14) * 256)) + (ax3 * 32)) + ((int)threadIdx.x)))];
          }
        }
        __syncthreads();
        #pragma unroll
        ...
        for (int ax2 = 0; ax2 < 8; ++ax2) {
          #pragma unroll
          for (int ax3_inner_inner = 0; ax3_inner_inner < 2; ++ax3_inner_inner) {
            ((int*)placeholder_shared)[(((((ax2 * 256) + (((int)threadIdx.z) * 64)) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder)[((((((((kh * 24576) + (kw * 8192)) + (((int)blockIdx.y) * 2048)) + (ax2 * 256)) + (((int)threadIdx.z) * 64)) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))];
          }
        }
        __syncthreads();
        #pragma unroll
        for (int ax21 = 0; ax21 < 2; ++ax21) {
          #pragma unroll
          for (int ax32 = 0; ax32 < 8; ++ax32) {
            (void)nvcuda::wmma::load_matrix_sync(placeholder_shared_wmma_matrix_b[((ax21 * 8) + ax32)], ((int *)placeholder_shared + (((((int)threadIdx.z) * 4096) + (ax21 * 2048)) + (ax32 * 256)) / 8), 32);
          }
        }
        #pragma unroll
        for (int ic_inner = 0; ic_inner < 8; ++ic_inner) {
    ...
    #pragma unroll
    for (int o_inner = 0; o_inner < 2; ++o_inner) {
      (void)nvcuda::wmma::store_matrix_sync(((int *)placeholder_shared + ((((int)threadIdx.z) * 128) + (o_inner * 64))), Conv_wmma_accumulator[o_inner], 8, nvcuda::wmma::mem_row_major);
    }
    __syncthreads();
    #pragma unroll
    for (int ax3_outer_inner = 0; ax3_outer_inner < 2; ++ax3_outer_inner) {
      #pragma unroll
      for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
        ((unsigned int*)T_cast)[((((((((((int)blockIdx.z) * 1024) + (ax0_inner_ax1_fused_inner * 256)) + (ax2_inner_ax3_inner_fused_outer * 128)) + ((((int)threadIdx.x) >> 3) * 32)) + (((int)blockIdx.y) * 8)) + (((int)threadIdx.z) * 2)) + ax3_outer_inner))] = ((unsigned int)((((((((0 | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((((int)threadIdx.z) * 128) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)))] + ((int*)placeholder1)[((((((int)blockIdx.y) * 64) + (((int)threadIdx.z) * 16)) + (ax3_outer_inner * 8)))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 28)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 128) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 1))] + ((int*)placeholder1)[(((((((int)blockIdx.y) * 64) + (((int)threadIdx.z) * 16)) + (ax3_outer_inner * 8)) + 1))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 24)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 128) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 2))] + ((int*)placeholder1)[(((((((int)blockIdx.y) * 64) + (((int)threadIdx.z) * 16)) + (ax3_outer_inner * 8)) + 2))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 20)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 128) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 3))] + ((int*)placeholder1)[(((((((int)blockIdx.y) * 64) + (((int)threadIdx.z) * 16)) + (ax3_outer_inner * 8)) + 3))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 16)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 128) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 4))] + ((int*)placeholder1)[(((((((int)blockIdx.y) * 64) + (((int)threadIdx.z) * 16)) + (ax3_outer_inner * 8)) + 4))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 12)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 128) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 5))] + ((int*)placeholder1)[(((((((int)blockIdx.y) * 64) + (((int)threadIdx.z) * 16)) + (ax3_outer_inner * 8)) + 5))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 8)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 128) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 6))] + ((int*)placeholder1)[(((((((int)blockIdx.y) * 64) + (((int)threadIdx.z) * 16)) + (ax3_outer_inner * 8)) + 6))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 4)) | (max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 128) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 7))] + ((int*)placeholder1)[(((((((int)blockIdx.y) * 64) + (((int)threadIdx.z) * 16)) + (ax3_outer_inner * 8)) + 7))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15)));
      }
    }
  }
}
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__9_kernel0(void* __restrict__ placeholder, void* __restrict__ placeholder1, void* __restrict__ T_cast, void* __restrict__ placeholder2) {
  ...
  for (int ax0_inner_ax1_fused_inner = 0; ax0_inner_ax1_fused_inner < 4; ++ax0_inner_ax1_fused_inner) {
    ...
    for (int ic_outer = 0; ic_outer < 2; ++ic_outer) {
      ...
      for (int kh = 0; kh < 3; ++kh) {
        ...
        for (int kw = 0; kw < 3; ++kw) {
          #pragma unroll
          for (int ax4_ax5_fused_inner_outer = 0; ax4_ax5_fused_inner_outer < 8; ++ax4_ax5_fused_inner_outer) {
            ((int*)compute_shared)[(((int)threadIdx.x))] = ((int*)placeholder)[(((((((((((((int)blockIdx.z) * 4) + ax0_inner_ax1_fused_inner) / 56) * 3712) + (kh * 3712)) + (kw * 64)) + ((((((int)blockIdx.z) * 4) + ax0_inner_ax1_fused_inner) % 56) * 64)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) >> 5) * 8)) + (ic_outer * 4)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) & 31) / 8)))];
          }
          __syncthreads();
          (void)nvcuda::wmma::load_matrix_sync(compute_shared_wmma_matrix_a[0], ((unsigned int *)compute_shared + 0 / 8), 32);
          #pragma unroll
          for (int ax2 = 0; ax2 < 8; ++ax2) {
            ((int*)placeholder_shared)[(((ax2 * 32) + ((int)threadIdx.x)))] = ((int*)placeholder1)[((((((kh * 1536) + (kw * 512)) + (ax2 * 64)) + (ic_outer * 32)) + ((int)threadIdx.x)))];
          }
          __syncthreads();
          #pragma unroll
          for (int ax21 = 0; ax21 < 8; ++ax21) {
    ...
    for (int ax3_outer_inner = 0; ax3_outer_inner < 8; ++ax3_outer_inner) {
      #pragma unroll
      for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
        ((unsigned int*)T_cast)[((((((((int)blockIdx.z) * 256) + (ax0_inner_ax1_fused_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + ax3_outer_inner))] = ((unsigned int)((((((((0 | ((max(min(((int)((((((long)max((Conv[((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)))] + ((int*)placeholder2)[((ax3_outer_inner * 8))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 28)) | ((max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 1))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 1))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 24)) | ((max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 2))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 2))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 20)) | ((max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 3))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 3))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 16)) | ((max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 4))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 4))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 12)) | ((max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 5))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 5))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 8)) | ((max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 6))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 6))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 4)) | (max(min(((int)((((((long)max((Conv[(((((ax3_outer_inner * 64) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 7))] + ((int*)placeholder2)[(((ax3_outer_inner * 8) + 7))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15)));
      }
    }
  }
}
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_cast_cast_left_shift_multiply_add_right_shift_cast_c_3441552496575213188__5_kernel0(void* __restrict__ placeholder, void* __restrict__ placeholder1, void* __restrict__ T_cast, void* __restrict__ placeholder2) {
  ...
  for (int ax0_inner_ax1_fused_inner = 0; ax0_inner_ax1_fused_inner < 4; ++ax0_inner_ax1_fused_inner) {
    ...
    for (int ax3 = 0; ax3 < 16; ++ax3) {
      ...
      for (int ax4_ax5_fused_inner_outer = 0; ax4_ax5_fused_inner_outer < 8; ++ax4_ax5_fused_inner_outer) {
        if (((int)threadIdx.z) < 1) {
          ((int*)compute_shared)[((((((int)threadIdx.z) * 512) + (ax3 * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder)[((((((((((((int)blockIdx.z) * 4) + ax0_inner_ax1_fused_inner) / 14) * 28672) + ((((((int)blockIdx.z) * 4) + ax0_inner_ax1_fused_inner) % 14) * 1024)) + (((int)threadIdx.z) * 512)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) >> 5) * 64)) + (ax3 * 4)) + ((((((int)threadIdx.x) * 8) + ax4_ax5_fused_inner_outer) & 31) / 8)))];
        }
      }
    }
    __syncthreads();
    ...
    for (int ic_outer = 0; ic_outer < 4; ++ic_outer) {
      ...
      for (int ax2 = 0; ax2 < 16; ++ax2) {
        #pragma unroll
        for (int ax3_inner_inner = 0; ax3_inner_inner < 2; ++ax3_inner_inner) {
          ((int*)placeholder_shared)[(((((ax2 * 128) + (((int)threadIdx.z) * 64)) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))] = ((int*)placeholder1)[(((((((((int)blockIdx.y) * 8192) + (ax2 * 512)) + (ic_outer * 128)) + (((int)threadIdx.z) * 64)) + (ax3_inner_inner * 32)) + ((int)threadIdx.x)))];
        }
      }
      __syncthreads();
      #pragma unroll
    ...
    for (int ax3_outer_inner = 0; ax3_outer_inner < 8; ++ax3_outer_inner) {
      #pragma unroll
      for (int ax2_inner_ax3_inner_fused_outer = 0; ax2_inner_ax3_inner_fused_outer < 2; ++ax2_inner_ax3_inner_fused_outer) {
        ((unsigned int*)T_cast)[((((((((((int)blockIdx.z) * 1024) + (ax0_inner_ax1_fused_inner * 256)) + (ax2_inner_ax3_inner_fused_outer * 128)) + ((((int)threadIdx.x) >> 3) * 32)) + (((int)blockIdx.y) * 16)) + (((int)threadIdx.z) * 8)) + ax3_outer_inner))] = ((unsigned int)((((((((0 | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[(((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)))] + ((int*)placeholder2)[((((((int)blockIdx.y) * 128) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 28)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 1))] + ((int*)placeholder2)[(((((((int)blockIdx.y) * 128) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + 1))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 24)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 2))] + ((int*)placeholder2)[(((((((int)blockIdx.y) * 128) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + 2))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 20)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 3))] + ((int*)placeholder2)[(((((((int)blockIdx.y) * 128) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + 3))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 16)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 4))] + ((int*)placeholder2)[(((((((int)blockIdx.y) * 128) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + 4))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 12)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 5))] + ((int*)placeholder2)[(((((((int)blockIdx.y) * 128) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + 5))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 8)) | ((max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 6))] + ((int*)placeholder2)[(((((((int)blockIdx.y) * 128) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + 6))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15) << 4)) | (max(min(((int)((((((long)max((((int*)placeholder_shared)[((((((((int)threadIdx.z) * 512) + (ax3_outer_inner * 64)) + (ax2_inner_ax3_inner_fused_outer * 32)) + ((((int)threadIdx.x) >> 3) * 8)) + 7))] + ((int*)placeholder2)[(((((((int)blockIdx.y) * 128) + (((int)threadIdx.z) * 64)) + (ax3_outer_inner * 8)) + 7))]), 0)) << (long)4) * (long)1258291200) + (long)1073741824) >> (long)31)), 15), 0) & 15)));
      }
    }
  }
}
